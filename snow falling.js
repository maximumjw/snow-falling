...
function renderWaterDrops() {
    for (var i = 0; i < waterDropsArray.length; i++) {
        ...
        else if (Math.abs(mouse.x - waterDropsArray[i].x + 35) <= 40&&0.0104*(mouse.x - waterDropsArray[i].x+35)*(mouse.x - waterDropsArray[i].x+35)+mouse.y<=waterDropsArray[i].y) {
            console.log(0.0104*(mouse.x - waterDropsArray[i].x-35)*(mouse.x - waterDropsArray[i].x-35)+mouse.y-waterDropsArray[i].y);
            for (var ind = 0; ind < 12; ind++) {
